...
def zoning_analysis_main(switch_params_aggregated_df, portshow_aggregated_df, 
    ...
    *_, max_title, report_steps_dct = report_data_lst
    ...
    data_names = ['zoning_aggregated', 'alias_aggregated', 'zonemember_statistics', 'portshow_zoned_aggregated', 
                    'Зонирование', 'Псевдонимы', 'Зонирование_A&B', 'Порты_не_в_зонах', 'Статистика_зон']
    ...
    zoning_aggregated_df, alias_aggregated_df, zonemember_statistics_df, \
        portshow_zoned_aggregated_df, zoning_report_df, alias_report_df, \
            zoning_compare_report_df, unzoned_device_report_df, \
    ...
    if force_run:
        ...
        zoning_report_df, alias_report_df, zoning_compare_report_df, \
            unzoned_device_report_df, zonemember_statistics_report_df = \
        ...
        data_lst = [zoning_aggregated_df, alias_aggregated_df, zonemember_statistics_df, 
                    portshow_zoned_aggregated_df, zoning_report_df, alias_report_df, 
                    zoning_compare_report_df, unzoned_device_report_df, zonemember_statistics_report_df]
