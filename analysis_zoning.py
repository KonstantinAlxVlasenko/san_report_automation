...
def zoning_analysis_main(switch_params_aggregated_df, portshow_aggregated_df, 
    ...
    *_, max_title, report_steps_dct = report_data_lst
    ...
    data_names = ['zoning_aggregated', 'alias_aggregated', 'zonemember_statistics', 
                    'portshow_zoned_aggregated', 'effective_cfg_statistics', 'Зонирование', 'Псевдонимы', 
                    'Зонирование_A&B', 'Порты_не_в_зонах', 'Порты_без_псевдономов', 
                    'Отсутсвуют_в_сети', 'Статистика_зон', 'Статистика_конфигурации']
    ...
    zoning_aggregated_df, alias_aggregated_df, zonemember_statistics_df, \
        portshow_zoned_aggregated_df, effective_cfg_statistics_df, zoning_report_df, alias_report_df, \
            zoning_compare_report_df, unzoned_device_report_df, no_alias_device_report_df, zoning_absent_device_report_df,\
                zonemember_statistics_report_df,  effective_cfg_statistics_report_df = data_lst
    ...
    if force_run:
        ...
        zoning_report_df, alias_report_df, zoning_compare_report_df, \
            unzoned_device_report_df, no_alias_device_report_df, zoning_absent_device_report_df, zonemember_statistics_report_df, effective_cfg_statistics_report_df = \
        ...
        data_lst = [zoning_aggregated_df, alias_aggregated_df, zonemember_statistics_df, 
                    portshow_zoned_aggregated_df, effective_cfg_statistics_df, zoning_report_df, alias_report_df, 
                    zoning_compare_report_df, unzoned_device_report_df, no_alias_device_report_df, 
                    zoning_absent_device_report_df, zonemember_statistics_report_df, effective_cfg_statistics_report_df]
    ...
    # verify if loaded data is empty and replace information string with empty DataFrame
        ...
        zoning_aggregated_df, alias_aggregated_df, zonemember_statistics_df, \
            portshow_zoned_aggregated_df, effective_cfg_statistics_df, zoning_report_df, alias_report_df, \
                zoning_compare_report_df, unzoned_device_report_df, no_alias_device_report_df, zoning_absent_device_report_df, \
                    zonemember_statistics_report_df, effective_cfg_statistics_report_df \
...
def note_to_aggregated_zoning(zoning_aggregated_df, zonemember_zonelevel_stat_df):
    """
