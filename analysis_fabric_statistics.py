...
def fabricstatistics_main(portshow_aggregated_df, switchshow_ports_df, fabricshow_ag_labels_df, 
    ...
    *_, max_title, report_steps_dct = report_data_lst
    ...
    data_names = ['statistics', 'Статистика']
    ...
    statistics_df, statistics_report_df = data_lst
    ...
    if force_run:
        ...
        statistics_df = statisctics_aggregated(portshow_aggregated_df, switchshow_ports_df, 
    ...
    # verify if loaded data is empty and replace information string with empty DataFrame
        ...
        statistics_df, statistics_report_df = \
