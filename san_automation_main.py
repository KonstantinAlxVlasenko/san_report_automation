...
# ssave_folder = r'C:\Users\vlasenko\Documents\01.CUSTOMERS\Megafon\All SANs\sw_test\Data'
...
# project_folder = r'C:\Users\vlasenko\Documents\01.CUSTOMERS\Megafon\All SANs\sw_test'
# Customer name
customer_name = r'stf_cust'
# customer_name = r'tattelecom'
# customer_name = r'sw-test'
...
def switch_params_check(parsed_lst, report_data_lst, chassis_params = 0, switch_params = 0, maps_params = 0, fabricshow = 0, portshow = 0):
    
    # _, _, _, max_title = report_data_lst
    *_, max_title = report_data_lst
    ...
    if portshow:
        export_lst_to_excel(portshow_lst, report_data_lst, 'portshow', 'portcmd')
...
if __name__ == "__main__":
    ...
    switch_params_check(config_data, report_data_lst, chassis_params = 1, switch_params = 1, maps_params = 1, fabricshow = 1, portshow = 1)
